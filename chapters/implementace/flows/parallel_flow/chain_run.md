...
Dále jsou definovány a použity traity `ChainSpawn`, sloužící k vytvoření asynchronních úloh,
a `ChainPollParallel`, sloužící k čekání na dokončení asynchronních úloh,
