...
Prvním případem je, že se vkládá první uzel do toku, a je nutno zajistit,
že vstup do toku lze převést na vstup do prvního uzlu
a chybu z uzlu lze převést na chybu toku.
...
je volána pouze jednou pro první uzel na novém builderu.
...
V této metodě není nutno kontrolovat, zda chybu posledního uzlu lze převést
