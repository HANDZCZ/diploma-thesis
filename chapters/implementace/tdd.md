...
Tento repozitář se nachází na adrese <https://github.com/HANDZCZ/node-flow/>.
...
ve kterém lze vidět, že testy se nacházejí na více místech.
Většina testů se nachází přímo u definice struktur,
