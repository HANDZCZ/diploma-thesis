...
Celé řešení pokud možno nemá využívat dynamic dispatch a trait objekty.
...
Tyto požadavky jsou také kontrolovány za kompilace a je možné předejít zbytečným chybám
za běhu programu.

V závěru tedy se autorovi povedlo navrhnout a implementovat plně statickou knihovnu,
